...
static coo_t globl_lfg_jac = {.row = (int[]){0, 0, 0, 1, 1, 1},
                              .col = (int[]){X_LFG_IDX(0), U_LFG_IDX(0), U_LFG_IDX(1), X_LFG_IDX(0), U_LFG_IDX(0), U_LFG_IDX(1)},
                              .buf_index = (int[]){0, 1, 2, 3, 4, 5},
                              .nnz = 6};

static coo_t globl_lfg_lt_hes = {.row = (int[]){U_LFG_IDX(0), U_LFG_IDX(1)}, .col = (int[]){U_LFG_IDX(0), U_LFG_IDX(1)}, .buf_index = (int[]){0, 1}, .nnz = 2};

static eval_structure_t globl_mr_eval = {.buf_index = (int[]){0}};

static coo_t globl_mr_jac = {.row = (int[]){0}, .col = (int[]){TF_MR_IDX}, .buf_index = (int[]){}, .nnz = 1};
...
static mesh_ref_ctx_t globl_mesh_ctx = {.initial_intervals = 10, .nodes_per_interval = 5, .l2bn_p1_it = 1, .l2bn_p2_it = 0, .l2bn_p2_lvl = 0.0};
