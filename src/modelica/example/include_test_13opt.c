...
{
  min[0] = data->modelData->realVarsData[6].attribute /* u */.min;
  max[0] = data->modelData->realVarsData[6].attribute /* u */.max;
  nominal[0] = data->modelData->realVarsData[6].attribute /* u */.nominal;
  useNominal[0] = data->modelData->realVarsData[6].attribute /* u */.useNominal;
  name[0] =(char *) data->modelData->realVarsData[6].info /* u */.name;
  start[0] = data->modelData->realVarsData[6].attribute /* u */.start;
...
int include_test_setInputData(DATA *data, const modelica_boolean file)
{
  ...
  data->simulationInfo->inputVars[0] = (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[6]] /* u variable */);
  TRACE_POP
  return 0;
}
