...
{
  *res =  &(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[4]] /* $OMC$objectMayerTerm variable */);
  *index_Dres = 2;
  return 0;
  return  -1;
}
...
{
  min[0] = data->modelData->realVarsData[11].attribute /* u */.min;
  max[0] = data->modelData->realVarsData[11].attribute /* u */.max;
  nominal[0] = data->modelData->realVarsData[11].attribute /* u */.nominal;
  useNominal[0] = data->modelData->realVarsData[11].attribute /* u */.useNominal;
  name[0] =(char *) data->modelData->realVarsData[11].info /* u */.name;
  start[0] = data->modelData->realVarsData[11].attribute /* u */.start;
...
int include_test_setInputData(DATA *data, const modelica_boolean file)
{
 TRACE_PUSH
   ...
   data->simulationInfo->inputVars[0] = (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[11]] /* u variable */);
 TRACE_POP
 return 0;
}
