...
bool IpoptAdapter::get_starting_point(Ipopt::Index n,
                                      bool init_x,
                                      Ipopt::Number *x,
                                      bool init_z,
                                      Ipopt::Number *z_L,
...
bool IpoptAdapter::get_scaling_parameters(Ipopt::Number &obj_scaling,
                                          bool &use_x_scaling,
                                          Ipopt::Index n,
...
bool IpoptAdapter::eval_jac_g(Ipopt::Index n,
...
bool IpoptAdapter::eval_h(Ipopt::Index n,
                          const Ipopt::Number *x,
                          bool new_x,
...
NLP::ReturnCode IpoptAdapter::get_return_code(Ipopt::SolverReturn status) {
    ...
    } else if (status == Ipopt::SolverReturn::CPUTIME_EXCEEDED || status == Ipopt::SolverReturn::WALLTIME_EXCEEDED) {
    ...
    } else if (status == Ipopt::SolverReturn::ERROR_IN_STEP_COMPUTATION || status == Ipopt::SolverReturn::INVALID_NUMBER_DETECTED ||
               status == Ipopt::SolverReturn::TOO_FEW_DEGREES_OF_FREEDOM || status == Ipopt::SolverReturn::INVALID_OPTION || status == Ipopt::SolverReturn::OUT_OF_MEMORY ||
               status == Ipopt::SolverReturn::INTERNAL_ERROR || status == Ipopt::SolverReturn::UNASSIGNED) {
        return NLP::ReturnCode::GENERIC_FAILURE;
    } else {
