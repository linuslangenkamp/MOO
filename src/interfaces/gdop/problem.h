...
public:
    FullSweep(GDOP::FullSweepLayout &&layout_in, const GDOP::ProblemConstants &pc, c_problem_t *c_problem)
...
public:
    BoundarySweep(GDOP::BoundarySweepLayout &&layout_in, const GDOP::ProblemConstants &pc, c_problem_t *c_problem)
...
public:
    Dynamics(const GDOP::ProblemConstants &pc, c_problem_t *c_problem_, std::shared_ptr<Trajectory[]> raw_data);
