...
Dynamics::Dynamics(const GDOP::ProblemConstants &pc, c_problem_t *c_problem_, std::shared_ptr<Trajectory[]> raw_data)
    : GDOP::Dynamics(pc, ::Simulation::Jacobian::sparse(::Simulation::JacobianFormat::COO, c_problem_->ode_jac->row, c_problem_->ode_jac->col, c_problem_->ode_jac->nnz)),
...
GDOP::Problem create_gdop_problem(c_problem_t *c_problem, std::shared_ptr<Trajectory[]> raw_data) {
    ...
    auto pc = std::make_unique<GDOP::ProblemConstants>(c_problem->has_mayer,
...
std::shared_ptr<Trajectory[]> create_raw_data(c_problem_t *c_problem) {
    ...
    std::shared_ptr<Trajectory[]> raw_data(new Trajectory[c_problem->data_file_count], std::default_delete<Trajectory[]>());
