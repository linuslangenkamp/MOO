...
std::shared_ptr<::NLP::Scaling> Problem::get_scaling() {
    ...
    const f64 obj_nominal = std::isfinite(c_problem->obj_nominal) && c_problem->obj_nominal != 0.0 ? std::abs(c_problem->obj_nominal) : 1.0;
...
void Problem::get_initial_guess(bool init_x,
